...
const summaryReports = [
  ...
  ['Error Rate Over Time', { bucket: '5m', group_by: ['service'], metric: 'error_rate', source: 'events' }],
  ['Top Services', { bucket: '5m', group_by: ['service'], metric: 'count', source: 'events' }],
  ['Top Event Types', { bucket: '5m', group_by: ['event_type'], metric: 'count', source: 'events' }],
  ['Top Names', { bucket: '5m', group_by: ['name'], metric: 'count', source: 'events' }],
  ['Top Environments', { bucket: '5m', group_by: ['environment'], metric: 'count', source: 'events' }],
  ...
  ['Trace Count Over Time', { bucket: '5m', group_by: ['service'], metric: 'trace_count', source: 'events' }],
  ['Erroring Traces Over Time', { bucket: '5m', group_by: ['service'], metric: 'error_count', source: 'events' }],
  ...
  ['Status Code Distribution', { bucket: '5m', group_by: ['http.response.status_code'], metric: 'count', source: 'events' }],
  ['Request Volume By Route', { bucket: '5m', group_by: ['http.route'], metric: 'count', source: 'events' }],
  ['Request Volume By Method', { bucket: '5m', group_by: ['http.method'], metric: 'count', source: 'events' }],
  ['Error Rate By Route', { bucket: '5m', group_by: ['http.route'], metric: 'error_rate', source: 'events' }],
  ['Log Volume By Severity', { bucket: '5m', group_by: ['severity_text'], metric: 'count', source: 'events' }],
  ['Log Volume By Logger', { bucket: '5m', group_by: ['logger.name'], metric: 'count', source: 'events' }],
  ['Metric Volume By Metric Name', { bucket: '5m', group_by: ['metric_name'], metric: 'count', source: 'events' }],
  ...
  ['Events By Page Path', { bucket: '5m', group_by: ['page_path'], metric: 'count', source: 'events' }],
  ['Events By Screen Name', { bucket: '5m', group_by: ['screen_name'], metric: 'count', source: 'events' }],
  ...
  ['Variant Split', { bucket: '1h', group_by: ['experiment_id', 'variant'], metric: 'count', source: 'events' }],
  ['Error Rate By Variant', { bucket: '1h', group_by: ['experiment_id', 'variant'], metric: 'error_rate', source: 'events' }],
  ['Volume By Country', { bucket: '1h', group_by: ['country'], metric: 'count', source: 'events' }],
  ['Volume By Device Type', { bucket: '1h', group_by: ['device_type'], metric: 'count', source: 'events' }],
  ['Volume By Browser', { bucket: '1h', group_by: ['browser'], metric: 'count', source: 'events' }],
  ['Volume By OS', { bucket: '1h', group_by: ['os'], metric: 'count', source: 'events' }]
]
